...
import product0 from '../photos/product0.jpg'; 
  ...
  return (
    <div className="admin-home">
      ...
      <div className="admin-content">
        ...
        {/* New Section: Clickable Rectangles */}
        <div className="clickable-rectangles">
          <div className="rectangle" onClick={() => navigate('/admin/labour')}>
            <h3>Labour</h3>
          </div>
          <div className="rectangle" onClick={() => navigate('/admin/inapp-marketplace')}>
            <h3>Marketplace</h3>
          </div>
          <div className="rectangle" onClick={() => navigate('/admin/carbon-credits')}>
            <h3>Carbon Credits</h3>
          </div>
          <div className="rectangle" onClick={() => navigate('/admin/rentals')}>
            <h3>Rentals</h3>
          </div>
        </div>
